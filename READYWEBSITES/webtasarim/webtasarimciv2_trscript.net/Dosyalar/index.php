...
<link href="css/eyapim2.css" rel="stylesheet" type="text/css" />
...
<div class="teklif-iste"><a href="includes/talep.php" class="video"><img src="images/teklif.png" /></a></div>
<div class="clear">
<!-- SLİDER -->
...
<div class="clear"></div>
    <div id="referans">
    <img src="images/left.png" class="rp" />
    <img src="images/right.png" class="rn" />
    	<div id="ara"><h2><?php echo DISTRIBUTORLER; ?></h2></div>
        <div class="clear"></div>
        <div id="reflist">
          <ul>
				<?php  $fonks->ortaks_footer(); ?>
         </ul>
      </div>
    </div>
