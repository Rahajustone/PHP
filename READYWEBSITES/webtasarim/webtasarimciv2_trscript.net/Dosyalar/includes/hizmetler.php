...
$sorgu=mysql_query("SELECT * FROM hizmet_alanlari WHERE id=".$id." LIMIT 1");
...
<div id="main">
  ...
  <div id="right">
   	<h1><img src="images/arrow_top.png" align="absmiddle" /> <a href="hizmet-alanlari"><?php echo HIZMET_ALAN; ?></a> <img src="images/arrow.png" /> <span><?php echo $yaz['baslik_'.$fonks->dil()]; ?></span></h1>
    <div class="clear"></div>
    <div class="text">
