...
$query = "SELECT * FROM haberler ORDER BY id DESC"; // sql 
...
$pager_url = "index.php?page=liste&sayfa="; // sayfalamanin yapildigi adres 
...
if(isset($_GET['sil']))
{
	$islem->host_resim('haberler',$eretna->sayi($_GET['sil']),'../uploads/','../uploads/thumbs/');
	$sil=mysql_query("DELETE FROM haberler WHERE id=".$eretna->sayi($_GET['sil'])." LIMIT 1");
	...
	<div class="box-header clear">
	  <h2>Haber Listesi</h2></div>
    	<div class="box-body clear">
		  ...
		  <th>Yayın Tarihi</th><th>İşlemler</th></tr></thead><tbody>
	<?php $sorgu=mysql_query($query." LIMIT ".$kgPagerOBJ -> start.", ".$kgPagerOBJ -> per_page."");
     ...
     <td><?php echo $yaz['baslik_eng']; ?></td>
      <td><?php echo $yaz['tarih']; ?></td>
		  <td>
          <a href="index.php?page=liste&sil=<?php echo $yaz['id']; ?>" onClick="return sil_kontrol('Silmek istediğinizden eminmisiniz')">
          <img src="images/ico_delete_16.png" class="icon16 fl-space2" alt="" title="Sil" />
          </a> 
          <a href="index.php?page=haber_duzenle&id=<?php echo $yaz['id']; ?>"><img src="images/ico_settings_16.png" class="icon16 fl-space2" alt="" title="Detay" /></a></td></tr>
