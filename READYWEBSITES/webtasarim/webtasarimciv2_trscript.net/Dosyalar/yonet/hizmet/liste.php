...
$query = "SELECT * FROM hizmet_alanlari ORDER BY id DESC"; // sql 
...
$pager_url = "index.php?page=hliste&sayfa="; // sayfalamanin yapildigi adres 
...
if(isset($_GET['sil']))
{
	$islem->host_resim('hizmet_alanlari',$eretna->sayi($_GET['sil']),'../uploads/','../uploads/thumbs/');
	$sil=mysql_query("DELETE FROM hizmet_alanlari WHERE id=".$eretna->sayi($_GET['sil'])." LIMIT 1");
	header("Location: index.php?page=hliste");
}
?>
<div class="page clear">
   <div class="content-box">
	<div class="box-header clear">
	  <h2>Hizmet Alanları Listesi</h2></div>
	...
	<?php $sorgu=mysql_query($query." LIMIT ".$kgPagerOBJ -> start.", ".$kgPagerOBJ -> per_page."");
     ...
     <tr>
     <td><a href="../uploads/<?php echo $yaz['resim']; ?>"><img src="../uploads/thumbs/<?php echo $yaz['resim']; ?>" width="75" style="border:#CCC 1px solid; padding:2px;"/></a></td>
     <td><?php echo $yaz['baslik_tr']; ?></td>
     <td><?php echo $yaz['baslik_eng']; ?></td>
      <td>
        <a href="index.php?page=hliste&sil=<?php echo $yaz['id']; ?>" onClick="return sil_kontrol('Silmek istediğinizden eminmisiniz')">
          <img src="images/ico_delete_16.png" class="icon16 fl-space2" alt="" title="Sil" />
          </a> 
        <a href="index.php?page=hizmet_duzenle&id=<?php echo $yaz['id']; ?>"><img src="images/ico_settings_16.png" class="icon16 fl-space2" alt="" title="Detay" /></a></td></tr>
