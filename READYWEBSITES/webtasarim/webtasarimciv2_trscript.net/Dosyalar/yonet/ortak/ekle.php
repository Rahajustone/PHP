...
if($_POST['rec']==1)
{
	...
	$islem3 = $eresim->yukle($_FILES['myfile2']);
	$sonuc2 = $eresim->mesaj($islem3);

	
	$kayit=mysql_query("INSERT INTO ortaks VALUES(NULL,'".$sonuc[0][1]."','".$sonuc2[0][1]."','".$baslik."','".$baslik2."','".$metin."','".$metin2."')");	
	if($kayit) 
	{ 
