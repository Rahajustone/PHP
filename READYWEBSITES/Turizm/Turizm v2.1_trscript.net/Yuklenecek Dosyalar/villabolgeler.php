...
$ilce_sef=str_replace('/','',$bolge_sef2);
$bolge=mysql_query("select * from villailceler where ilce_sef='$ilce_sef'");
$bolgeveri = mysql_fetch_array($bolge);

$indexoteller=mysql_query("select * from villalar where villa_bolge_id='$bolgeveri[ilce_id]' order by villa_id desc");
$sayi=1;
