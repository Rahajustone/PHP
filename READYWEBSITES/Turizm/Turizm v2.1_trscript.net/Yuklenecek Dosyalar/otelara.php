...
elseif($otel_kampanya=='1'){
$search="and otel_erken=".$otel_kampanya;
}
elseif($otel_kampanya=='2'){
$search="and otel_kaplica=".$otel_kampanya;
}
elseif($otel_firsat=='3'){
$search="and otel_firsat=".$otel_kampanya;
}
elseif($otel_bayram=='4'){
$search="and otel_bayram=".$otel_kampanya;
}

$indexoteller=mysql_query("select * from oteller where otel_bolge_id='$bolge' and otel_yildiz='$yildiz' and konaklama_id='$otel_tipi' $search order by otel_id desc");
