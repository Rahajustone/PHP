...
$ekle=mysql_query("INSERT INTO tarih_araligi (otel_id,tarih_alis_gun,tarih_alis_ay,tarih_donus_gun,tarih_donus_ay,tarih_yil) ".
"VALUES('$_GET[otel_id]','$tarih_alis_gun','$tarih_alis_ay','$tarih_donus_gun','$tarih_alis_ay','$tarih_yil')");
...
<form action="oteltarih.php?ekle=ekle&otel_id=<? echo $_GET[otel_id]; ?>" method="post" enctype="multipart/form-data">
...
<?
$ayar=mysql_query("select * from tarih_araligi where otel_id='$_GET[otel_id]' order by tarih_alis_gun,tarih_alis_ay asc");
$sayi=1;
...
?>   
						...
						<div class="sol sil" style="background:<? echo $renk; ?>"><a href="oteltarih.php?otel_id=<? echo $ayarveri[otel_id]; ?>&tarih_id=<? echo $ayarveri[tarih_id]; ?>&sil=sil"><img src="tema/sil.png" alt="" /></a></div>
<? $sayi++; } ?>
                    </div>
                </div>
