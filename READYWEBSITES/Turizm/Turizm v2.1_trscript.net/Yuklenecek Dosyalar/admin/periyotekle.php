...
?>
        	...
        	<div id="ortaalan" class="sol">
                <div class="sol temizle">
                    <div class="sol solbaslik fontkalin">PERİYOT ARALIĞI EKLE</div>
                    <div class="sol alt">
<? if($_GET[ekle]==ekle) { 
...
echo '<div class="sol list4 fontkalin" style="background:#fff;">Periyot Aralığı Eklendi</div>';
}
?>

<form action="periyotekle.php?ekle=ekle" method="post">
					<div class="temizle sol inputadi fontkalin">
						<span class="sol" style="display:block; margin-left:0;">Alış Gün / Ay</span>
					</div>
					...
					<div class="temizle sol inputadi fontkalin">
						<span class="sol" style="display:block; margin-left:0;">Dönüş Gün / Ay</span>
					</div>
					<div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik">
