...
<?
if($_GET[sil]==sil){
$silindi=mysql_query("DELETE FROM rezervasyon where rezervasyon_id='$_GET[rezervasyon_id]' and durum='1'");
...
<?
$ayar=mysql_query("select * from rezervasyon where durum='1' order by rezervasyon_id desc limit 40");
$sayi=1;
...
?>   
						...
						<div class="sol sil" style="background:<? echo $renk; ?>"><a href="onaylananrezervasyonlar.php?rezervasyon_id=<? echo $ayarveri[rezervasyon_id]; ?>&sil=sil"><img src="tema/sil.png" alt="" /></a></div>
