...
<form action="villaanahtarkelimeler.php?ekle=ekle&villa_id=<? echo $_GET[villa_id]; ?>" method="post">
				...
				<div id="TR" class="aciklama temizle sol" style="display: block;">
					<div class="sol inputadi fontkalin"><img src="tema/tr.png" alt="" align="left" style="margin-right:2px" /> <span style="padding-top:3px; display:block;">Sayfa Başlığı (Title)</span></div><div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik"><input type="text" name="villa_title_tr" value="<? echo $otelveri[villa_title_tr]; ?>"></div>
                ...
                <div id="EN" class="aciklama temizle sol" style="display: none;">
					<div class="sol inputadi fontkalin"><img src="tema/en.png" alt="" align="left" style="margin-right:2px" /> <span style="padding-top:3px; display:block;">Sayfa Başlığı (Title)</span></div><div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik"><input type="text" name="villa_title_en" value="<? echo $otelveri[villa_title_en]; ?>"></div>
