...
?>
        	...
        	<div id="ortaalan" class="sol">
                <div class="sol temizle">
                    <div class="sol solbaslik fontkalin">TARİH ARALIĞI EKLE</div>
                    <div class="sol alt">
<? if($_GET[ekle]==ekle) { 
...
echo '<div class="sol list4 fontkalin" style="background:#fff;">Tarih Aralığı Eklendi</div>';
}
?>
...
<form action="tarihekle.php?ekle=ekle&oda_tipi_id=<? echo $_GET[oda_tipi_id]; ?>" method="post">
					<div class="temizle sol inputadi fontkalin">
						<span class="sol" style="display:block; margin-left:0;">Giriş Gün / Ay</span>
					</div>
					...
					<div class="temizle sol inputadi fontkalin">
						<span class="sol" style="display:block; margin-left:0;">Çıkış Gün</span>
					</div>
					<div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik">
					...
					<div class="temizle sol inputadi fontkalin">
						<span class="sol" style="display:block; margin-left:0;">Ücret</span>
					</div>
					<div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik">
