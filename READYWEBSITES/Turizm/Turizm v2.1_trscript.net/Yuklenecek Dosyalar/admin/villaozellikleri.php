...
echo '<div class="sol list4 fontkalin" style="background:#fff; width:970px">Villa Özellikleri Düzenlendi. <a href="villaduzenle.php?villa_id='.$_GET[villa_id].'">Geri Dön</a></div>';
}
else {
echo '<div class="sol list4 fontkalin" style="background:#fff; width:970px"><a href="villaduzenle.php?villa_id='.$_GET[villa_id].'">Geri Dön</a></div>';
}
