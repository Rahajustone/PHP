        ...
        <div class="temizle sol" style="margin-top:25px">
        	<div id="ortaalan" class="sol" style="width:1000px">
                <div class="sol temizle">
					<form action="ucretliaktiviteler.php?guncelle=guncelle&otel_id=<? echo $_GET[otel_id]; ?>" method="post">
                    <div class="sol otel fontkalin">OTEL ÜCRETLİ AKTİVİTELER ÖZELLİKLERİNİ DÜZENLEME ALANI</div>
                    <div class="sol otelalt">
<?

if($_GET[guncelle]=='guncelle'){
$sonuc=mysql_query("UPDATE oteller set otel_ucretli_aktiviteler='$_POST[hotel_fea]' where otel_id='$_GET[otel_id]'");
echo '<div class="sol list4 fontkalin" style="background:#fff; width:970px">Otel Ücretli Aktivite Özellikleri Düzenlendi. <a href="otelduzenle.php?otel_id='.$_GET[otel_id].'">Geri Dön</a></div>';
}
else {
...
?>
					<div class="sol temizle"><input name="hotel_fea" id="hotel_fea" value="<? echo $otelveri[otel_ucretli_aktiviteler]; ?>" wdg:recordset="rsFeas" wdg:subtype="CommaCheckboxes" wdg:type="widget" wdg:displayfield="fea_name" wdg:valuefield="fea_ID" wdg:groupby="5" /></div>
