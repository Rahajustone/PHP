...
?>
        	...
        	<div id="ortaalan" class="sol">
                <div class="sol temizle">
                    <div class="sol solbaslik fontkalin">TATİL BÖLGESİ EKLE</div>
                    <div class="sol alt">
<? if($_GET[ekle]==ekle) { 
...
$ekle=mysql_query("INSERT INTO ilceler (il_id,ilce_adi_tr,ilce_adi_en,ilce_sef) ".
"VALUES('$_GET[il_id]','$ilce_adi_tr','$ilce_adi_en','$ilce_sef')");
echo '<div class="sol list4 fontkalin" style="background:#fff;">Tatil Bölgesi Eklendi</div>';
}
?>

<form action="bolgeekle.php?ekle=ekle&il_id=<? echo $_GET[il_id]; ?>" method="post">
