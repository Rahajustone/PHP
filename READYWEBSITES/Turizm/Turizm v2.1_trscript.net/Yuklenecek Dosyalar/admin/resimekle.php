...
?>
        	...
        	<div id="ortaalan" class="sol">
                <div class="sol temizle">
                    <div class="sol solbaslik fontkalin">RESMİ EKLE</div>
                    <div class="sol alt">
<? if($_GET[ekle]==ekle) { 
...
$ekle=mysql_query("INSERT INTO galeri_resim (icerik_id,galeri_resim_adi) ".
"VALUES('$_GET[icerik_id]','$resim')");
}
if($_GET[sabit]==sabit){
$ekle=mysql_query("INSERT INTO galeri_resim (sabit_id,galeri_resim_adi) ".
"VALUES('$_GET[sabit_id]','$resim')");
}
...
<? if($_GET[icerik]==icerik){ ?>
<form action="resimekle.php?ekle=ekle&icerik_id=<? echo $_GET[icerik_id]; ?>&icerik=icerik" method="post" enctype="multipart/form-data">
					<div class="temizle sol inputadi fontkalin"><span style="padding-top:3px; display:block;">İçerik Sayfası Resim Ekle</span></div><div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik"><input type="file" name="resimx" style="border:1px solid #444; width:400px"></div>
					<div class="sol temizle" style="margin-left:208px"><input type="submit" value="Resim Ekle" style="width:150px" /></div>
</form>
<? } ?>
<? if($_GET[sabit]==sabit){ ?>
<form action="resimekle.php?ekle=ekle&sabit_id=<? echo $_GET[sabit_id]; ?>&sabit=sabit" method="post" enctype="multipart/form-data">
					<div class="temizle sol inputadi fontkalin"><span style="padding-top:3px; display:block;">Sabit İçerik Resim Ekle</span></div><div class="sol inputnokta fontkalin">:</div><div class="sol inputicerik"><input type="file" name="resimx" style="border:1px solid #444; width:400px"></div>
					<div class="sol temizle" style="margin-left:208px"><input type="submit" value="Resim Ekle" style="width:150px" /></div>
</form>
<? } ?>
                    </div>
