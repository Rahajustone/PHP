...
<?
if($_GET[sil]==sil){
$silindi=mysql_query("DELETE FROM rezervasyon where rezervasyon_id='$_GET[rezervasyon_id]' and durum='2'");
...
<?
$ayar=mysql_query("select * from rezervasyon where durum='2' order by rezervasyon_id desc limit 40");
$sayi=1;
...
?>   
						...
						<div class="sol sil" style="background:<? echo $renk; ?>"><a href="iptaledilenrezervasyonlar.php?rezervasyon_id=<? echo $ayarveri[rezervasyon_id]; ?>&sil=sil"><img src="tema/sil.png" alt="" /></a></div>
