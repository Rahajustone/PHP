...
$guncelle = mysql_query("UPDATE aracrezervasyon SET durum='$_POST[durum]' WHERE rezervasyon_id='$_GET[rezervasyon_id]'");
echo '<div class="sol list4 fontkalin" style="background:#fff; width:697px">Rezervasyon Düzenlendi.</div>';
}
?>
<form action="rentacarrezervasyonduzenle.php?duzenle=duzenle&rezervasyon_id=<? echo $_GET[rezervasyon_id]; ?>" method="post">
<?
...
$otelveri = mysql_fetch_array($otel);
 echo "
							...
							<div style='width:710px; float:left; margin-right:10px; margin-bottom:10px'>
								...
								<div style='clear:both; height:25px;'><span style='float:left; width:150px; display:block'>İade Tarihi</span><span style='float:left; width:550px; display:block'>: ".$rezerveri[cikistarihi]."</span></div>
							</div>";
?>
