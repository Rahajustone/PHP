...
$sonuc=mysql_query("UPDATE oteller set boylam='$_POST[boylam]',enlem='$_POST[enlem]' where otel_id='$_GET[otel_id]'");
...
<form action="googlemaps.php?ekle=ekle&otel_id=<? echo $_GET[otel_id]; ?>" method="post">
