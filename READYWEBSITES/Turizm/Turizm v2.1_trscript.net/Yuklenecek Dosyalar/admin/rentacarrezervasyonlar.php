...
<?
if($_GET[sil]==sil){
$silindi=mysql_query("DELETE FROM aracrezervasyon where rezervasyon_id='$_GET[rezervasyon_id]'");
...
<?
$ayar=mysql_query("select * from aracrezervasyon order by rezervasyon_id desc limit 40");
$sayi=1;
...
?>   
						...
						<div class="sol sil" style="background:<? echo $renk; ?>"><a href="rentacarrezervasyonlar.php?rezervasyon_id=<? echo $ayarveri[rezervasyon_id]; ?>&sil=sil"><img src="tema/sil.png" alt="" /></a></div>
